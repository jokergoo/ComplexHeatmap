...
<title>Number of Observations — nobs.HeatmapAnnotation • ComplexHeatmap</title>
...
<meta property="og:title" content="Number of Observations — nobs.HeatmapAnnotation" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>nobs.HeatmapAnnotation.rd</code></div>
    </div>
...
<span class='fu'><a href='https://rdrr.io/r/stats/nobs.html'>nobs</a></span>(<span class='no'>object</span>, <span class='no'>...</span>)</pre>
    ...
    <p>If there is no <code>nobs</code> information for any of its <code><a href='SingleAnnotation-class.rd.html'>SingleAnnotation-class</a></code> object,
it returns <code>NA</code>.</p>
