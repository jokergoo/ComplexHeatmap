...
<title>Degrees of the Combination sets — comb_degree • ComplexHeatmap</title>
...
<meta property="og:title" content="Degrees of the Combination sets — comb_degree" />

<meta property="og:description" content="Degrees of the Combination sets" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Degrees of the Combination sets</h1>
    
    <div class="hidden name"><code>comb_degree.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Degrees of the Combination sets</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='comb_degree.rd.html'>comb_degree</a></span>(<span class='no'>m</span>)</pre>
    ...
    <p>The degree for a combination set is the number of sets that are selected.</p>
    
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>A vector of degrees of the combination sets.</p>
...
<span class='fu'><a href='comb_degree.rd.html'>comb_degree</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt; 010 001 110 101 011 111 
#&gt;   1   1   2   2   2   3 </div></pre>
  </div>
