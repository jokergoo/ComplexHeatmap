...
<title>Draw Heatmap List Title — draw_title-HeatmapList-method • ComplexHeatmap</title>
...
<meta property="og:title" content="Draw Heatmap List Title — draw_title-HeatmapList-method" />

<meta property="og:description" content="Draw Heatmap List Title" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Draw Heatmap List Title</h1>
    
    <div class="hidden name"><code>draw_title-HeatmapList-method.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Draw Heatmap List Title</p>
...
<span class='fu'><a href='draw_title-dispatch.rd.html'>draw_title</a></span>(<span class='no'>object</span>,
    <span class='kw'>which</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='st'>"column"</span>, <span class='st'>"row"</span>))</pre>
    ...
    <p>A viewport is created which contains heatmap list title.</p>
