...
<title>Draw the List of Heatmaps — draw_heatmap_list-HeatmapList-method • ComplexHeatmap</title>
...
<meta property="og:title" content="Draw the List of Heatmaps — draw_heatmap_list-HeatmapList-method" />

<meta property="og:description" content="Draw the List of Heatmaps" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Draw the List of Heatmaps</h1>
    
    <div class="hidden name"><code>draw_heatmap_list-HeatmapList-method.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Draw the List of Heatmaps</p>
    
    </div>

    <pre class="usage"><span class='co'># S4 method for HeatmapList</span>
<span class='fu'><a href='draw_heatmap_list-HeatmapList-method.rd.html'>draw_heatmap_list</a></span>(<span class='no'>object</span>)</pre>
    ...
    <p>It only draws the list of heatmaps without legends and titles.</p>
