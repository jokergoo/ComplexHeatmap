...
<title>Extract Elements in a Combination set — extract_comb • ComplexHeatmap</title>
...
<meta property="og:title" content="Extract Elements in a Combination set — extract_comb" />

<meta property="og:description" content="Extract Elements in a Combination set" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Extract Elements in a Combination set</h1>
    
    <div class="hidden name"><code>extract_comb.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Extract Elements in a Combination set</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='extract_comb.rd.html'>extract_comb</a></span>(<span class='no'>m</span>, <span class='no'>comb_name</span>)</pre>
    ...
    <tr>
      <th>comb_name</th>
      <td><p>The valid combination set name should be from <code><a href='comb_name.rd.html'>comb_name</a></code>.</p></td>
    </tr>
    </table>
    
    <h2 class="hasAnchor" id="details"><a class="anchor" href="#details"></a>Details</h2>

    <p>It returns the combination set.</p>
...
<span class='fu'><a href='extract_comb.rd.html'>extract_comb</a></span>(<span class='no'>m</span>, <span class='st'>"110"</span>)</div><div class='output co'>#&gt; [1] "s" "n" "c" "k"</div></pre>
  </div>
