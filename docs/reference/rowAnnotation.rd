...
<title>Construct Row Annotations — rowAnnotation • ComplexHeatmap</title>
...
<meta property="og:title" content="Construct Row Annotations — rowAnnotation" />

<meta property="og:description" content="Construct Row Annotations" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Construct Row Annotations</h1>
    
    <div class="hidden name"><code>rowAnnotation.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Construct Row Annotations</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='rowAnnotation.rd.html'>rowAnnotation</a></span>(<span class='no'>...</span>)</pre>
...
<p></p><pre>
    HeatmapAnnotation(..., which = "row")  </pre>
