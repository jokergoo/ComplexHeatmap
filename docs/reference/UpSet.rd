...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <pre class="usage"><span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m</span>,
    ...
    <span class='kw'>set_order</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/order.html'>order</a></span>(<span class='fu'><a href='set_size.rd.html'>set_size</a></span>(<span class='no'>m</span>), <span class='kw'>decreasing</span> <span class='kw'>=</span> <span class='fl'>TRUE</span>),
    ...
    <span class='fu'><a href='order.comb_mat.rd.html'>order.comb_mat</a></span>(<span class='no'>m</span>[<span class='no'>set_order</span>, ], <span class='kw'>decreasing</span> <span class='kw'>=</span> <span class='fl'>TRUE</span>)
    } <span class='kw'>else</span> {
    <span class='fu'><a href='order.comb_mat.rd.html'>order.comb_mat</a></span>(<span class='no'>m</span>[, <span class='no'>set_order</span>], <span class='kw'>decreasing</span> <span class='kw'>=</span> <span class='fl'>TRUE</span>)
    },
    <span class='kw'>top_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_top_annotation.rd.html'>upset_top_annotation</a></span>(<span class='no'>m</span>),
    <span class='kw'>right_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_right_annotation.rd.html'>upset_right_annotation</a></span>(<span class='no'>m</span>),
    ...
    <tr>
      <th>m</th>
      <td><p>A combination matrix returned by <code><a href='make_comb_mat.rd.html'>make_comb_mat</a></code>. The matrix can be transposed to switch the position of sets and combination sets.</p></td>
    </tr>
    <tr>
      <th>comb_col</th>
    ...
    <tr>
      ...
      <td><p>A <code><a href='HeatmapAnnotation.rd.html'>HeatmapAnnotation</a></code> object on top of the combination matrix.</p></td>
    </tr>
    <tr>
      <th>right_annotation</th>
      <td><p>A <code><a href='HeatmapAnnotation.rd.html'>HeatmapAnnotation</a></code> object on the right of the combination matrix.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      <th>...</th>
      <td><p>Other arguments passed to <code><a href='Heatmap.rd.html'>Heatmap</a></code>.</p></td>
    </tr>
    </table>
...
The annotations are simply constructed by <code><a href='HeatmapAnnotation.rd.html'>HeatmapAnnotation</a></code> and <code><a href='anno_barplot.rd.html'>anno_barplot</a></code> with some
parameters pre-set. Users can check the source code of <code><a href='upset_top_annotation.rd.html'>upset_top_annotation</a></code> and
<code><a href='upset_right_annotation.rd.html'>upset_right_annotation</a></code> to find out how the annotations are defined.</p>
<p>To change or to add annotations, users just need to define a new <code><a href='HeatmapAnnotation.rd.html'>HeatmapAnnotation</a></code> object.
...
<p>To add more annotations on top, users just add it in <code><a href='HeatmapAnnotation.rd.html'>HeatmapAnnotation</a></code>:</p>
<p></p><pre>
    Upset(..., top_annotation = 
        HeatmapAnnotation(
           "Intersection size" = anno_barplot(
...
<p><code><a href='UpSet.rd.html'>UpSet</a></code> returns a <code><a href='Heatmap-class.rd.html'>Heatmap-class</a></code> object, which means, you can add it with other heatmaps and annotations
by <code>+</code> or <code><a href='pct_v_pct.rd.html'>%v%</a></code>.</p>
...
<span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m</span>)</div><div class='img'><img src='UpSet-1.png' alt='' width='700' height='433' /></div><div class='input'><span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='fu'><a href='https://rdrr.io/r/base/t.html'>t</a></span>(<span class='no'>m</span>))</div><div class='img'><img src='UpSet-2.png' alt='' width='700' height='433' /></div><div class='input'>
<span class='no'>m</span> <span class='kw'>=</span> <span class='fu'><a href='make_comb_mat.rd.html'>make_comb_mat</a></span>(<span class='no'>lt</span>, <span class='kw'>mode</span> <span class='kw'>=</span> <span class='st'>"union"</span>)
<span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m</span>)</div><div class='img'><img src='UpSet-3.png' alt='' width='700' height='433' /></div><div class='input'><span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m</span>, <span class='kw'>comb_col</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fu'><a href='https://rdrr.io/r/base/rep.html'>rep</a></span>(<span class='fl'>2</span>, <span class='fl'>3</span>), <span class='fu'><a href='https://rdrr.io/r/base/rep.html'>rep</a></span>(<span class='fl'>3</span>, <span class='fl'>3</span>), <span class='fl'>1</span>))</div><div class='img'><img src='UpSet-4.png' alt='' width='700' height='433' /></div><div class='input'>
...
<span class='no'>lt1</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/list.html'>list</a></span>(<span class='kw'>a</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>10</span>),
          <span class='kw'>b</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>15</span>),
          <span class='kw'>c</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>20</span>))
<span class='no'>m1</span> <span class='kw'>=</span> <span class='fu'><a href='make_comb_mat.rd.html'>make_comb_mat</a></span>(<span class='no'>lt1</span>)
...
<span class='no'>lt2</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/list.html'>list</a></span>(<span class='kw'>a</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>10</span>),
          <span class='kw'>b</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>15</span>),
          <span class='kw'>c</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/sample.html'>sample</a></span>(<span class='no'>letters</span>, <span class='fl'>20</span>))
<span class='no'>m2</span> <span class='kw'>=</span> <span class='fu'><a href='make_comb_mat.rd.html'>make_comb_mat</a></span>(<span class='no'>lt2</span>)

<span class='no'>max1</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/Extremes.html'>max</a></span>(<span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fu'><a href='set_size.rd.html'>set_size</a></span>(<span class='no'>m1</span>), <span class='fu'><a href='set_size.rd.html'>set_size</a></span>(<span class='no'>m2</span>)))
<span class='no'>max2</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/Extremes.html'>max</a></span>(<span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fu'><a href='comb_size.rd.html'>comb_size</a></span>(<span class='no'>m1</span>), <span class='fu'><a href='comb_size.rd.html'>comb_size</a></span>(<span class='no'>m2</span>)))

<span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m1</span>, <span class='kw'>top_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_top_annotation.rd.html'>upset_top_annotation</a></span>(<span class='no'>m1</span>, <span class='kw'>ylim</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fl'>0</span>, <span class='no'>max2</span>)),
    <span class='kw'>right_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_right_annotation.rd.html'>upset_right_annotation</a></span>(<span class='no'>m1</span>, <span class='kw'>ylim</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fl'>0</span>, <span class='no'>max1</span>)),
    <span class='kw'>column_title</span> <span class='kw'>=</span> <span class='st'>"UpSet1"</span>) +
<span class='fu'><a href='UpSet.rd.html'>UpSet</a></span>(<span class='no'>m2</span>, <span class='kw'>top_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_top_annotation.rd.html'>upset_top_annotation</a></span>(<span class='no'>m2</span>, <span class='kw'>ylim</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fl'>0</span>, <span class='no'>max2</span>)),
    <span class='kw'>right_annotation</span> <span class='kw'>=</span> <span class='fu'><a href='upset_right_annotation.rd.html'>upset_right_annotation</a></span>(<span class='no'>m2</span>, <span class='kw'>ylim</span> <span class='kw'>=</span> <span class='fu'><a href='https://rdrr.io/r/base/c.html'>c</a></span>(<span class='fl'>0</span>, <span class='no'>max1</span>)),
