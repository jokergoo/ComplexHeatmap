...
<title>Set Sizes — set_size • ComplexHeatmap</title>
...
<meta property="og:title" content="Set Sizes — set_size" />

<meta property="og:description" content="Set Sizes" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>set_size.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='fu'><a href='set_size.rd.html'>set_size</a></span>(<span class='no'>m</span>)</pre>
...
<span class='fu'><a href='set_size.rd.html'>set_size</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt;  a  b  c 
#&gt; 10 15 20 </div></pre>
  </div>
