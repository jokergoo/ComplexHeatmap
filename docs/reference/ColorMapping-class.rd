...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Class for Color Mapping</h1>
    
    <div class="hidden name"><code>ColorMapping-class.rd</code></div>
    </div>
...
<ul>
<li><p><code><a href='ColorMapping.rd.html'>ColorMapping</a></code>: contructor methods.</p></li>
