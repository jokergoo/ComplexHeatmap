...
<title>Transpost the Combination Matrix — t.comb_mat • ComplexHeatmap</title>
...
<meta property="og:title" content="Transpost the Combination Matrix — t.comb_mat" />

<meta property="og:description" content="Transpost the Combination Matrix" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Transpost the Combination Matrix</h1>
    
    <div class="hidden name"><code>t.comb_mat.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Transpost the Combination Matrix</p>
    
    </div>

    <pre class="usage"><span class='co'># S3 method for comb_mat</span>
<span class='fu'><a href='https://rdrr.io/r/base/t.html'>t</a></span>(<span class='no'>x</span>)</pre>
...
<span class='fu'><a href='https://rdrr.io/r/base/t.html'>t</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt; A combination matrix with 3 sets and 6 combinations.
