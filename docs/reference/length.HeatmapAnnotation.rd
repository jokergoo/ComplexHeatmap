...
<title>Number of Annotations — length.HeatmapAnnotation • ComplexHeatmap</title>
...
<meta property="og:title" content="Number of Annotations — length.HeatmapAnnotation" />

<meta property="og:description" content="Number of Annotations" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>length.HeatmapAnnotation.rd</code></div>
    </div>
...
<span class='fu'><a href='https://rdrr.io/r/base/length.html'>length</a></span>(<span class='no'>x</span>)</pre>
