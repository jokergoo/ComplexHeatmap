...
<title>Decorate Heatmap Dendrograms — decorate_dend • ComplexHeatmap</title>
...
<meta property="og:title" content="Decorate Heatmap Dendrograms — decorate_dend" />

<meta property="og:description" content="Decorate Heatmap Dendrograms" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <tr>
      <th>code</th>
      <td><p>Code that adds graphics in the selected heatmap dendrogram.</p></td>
    </tr>
    <tr>
      <th>slice</th>
    ...
    <tr>
      <th>which</th>
      <td><p>Is the dendrogram on rows or on columns?</p></td>
    </tr>
    <tr>
      <th>envir</th>
    ...
    <p>If you know the number of leaves in the dendrogram, it is
simple to calculate the position of every leave in the dendrogram.
E.g., for the column dendrogram, the i^th leave is located at:</p>
<p></p><pre>
...
<span class='fu'><a href='Heatmap.rd.html'>Heatmap</a></span>(<span class='fu'><a href='https://rdrr.io/r/base/matrix.html'>matrix</a></span>(<span class='fu'><a href='https://rdrr.io/r/stats/Normal.html'>rnorm</a></span>(<span class='fl'>100</span>), <span class='fl'>10</span>), <span class='kw'>name</span> <span class='kw'>=</span> <span class='st'>"mat"</span>, <span class='kw'>km</span> <span class='kw'>=</span> <span class='fl'>2</span>)</div><div class='input'><span class='fu'><a href='decorate_dend.rd.html'>decorate_dend</a></span>(<span class='st'>"mat"</span>, {
...
}, <span class='kw'>which</span> <span class='kw'>=</span> <span class='st'>"row"</span>, <span class='kw'>slice</span> <span class='kw'>=</span> <span class='fl'>2</span>)</div><div class='img'><img src='decorate_dend-1.png' alt='' width='700' height='433' /></div></pre>
  </div>
