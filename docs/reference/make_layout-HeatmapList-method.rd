...
<title>Make Layout for the Heatmap List — make_layout-HeatmapList-method • ComplexHeatmap</title>
...
<meta property="og:title" content="Make Layout for the Heatmap List — make_layout-HeatmapList-method" />

<meta property="og:description" content="Make Layout for the Heatmap List" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Make Layout for the Heatmap List</h1>
    
    <div class="hidden name"><code>make_layout-HeatmapList-method.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Make Layout for the Heatmap List</p>
    
    </div>

    <pre class="usage"><span class='co'># S4 method for HeatmapList</span>
<span class='fu'><a href='make_layout-dispatch.rd.html'>make_layout</a></span>(<span class='no'>object</span>,
    ...
    <span class='kw'>ht_gap</span> <span class='kw'>=</span> <span class='fu'>unit</span>(<span class='fl'>2</span>, <span class='st'>"mm"</span>),
    ...
    <span class='kw'>heatmap_width</span> <span class='kw'>=</span> <span class='kw'>NULL</span>)</pre>
    ...
    <tr>
      ...
      <td><p>Will the title be put on the left or right of the heatmap list?</p></td>
    </tr>
    <tr>
      <th>row_title_gp</th>
      <td><p>Graphic parameters for the row title.</p></td>
    </tr>
    <tr>
      <th>column_title</th>
    ...
    <tr>
      ...
      <td><p>Graphic parameters for the column title.</p></td>
    </tr>
    <tr>
      <th>heatmap_legend_side</th>
      <td><p>Side of the heatmap legends.</p></td>
    </tr>
    <tr>
      <th>merge_legends</th>
      <td><p>Whether to put heatmap legends and annotation legends together. By default they are put in different viewports.</p></td>
    </tr>
    <tr>
      <th>show_heatmap_legend</th>
      <td><p>Whether show heatmap legends.</p></td>
    </tr>
    <tr>
      <th>heatmap_legend_list</th>
      <td><p>A list of self-defined legends, should be wrapped into a list of <code><a href='https://rdrr.io/r/grid/grid-defunct.html'>grob</a></code> objects. Normally they are constructed by <code><a href='Legend.rd.html'>Legend</a></code>.</p></td>
    </tr>
    <tr>
      <th>annotation_legend_side</th>
      <td><p>Side of annotation legends.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      <th>ht_gap</th>
      <td><p>Gap between heatmaps, should be a <code><a href='https://rdrr.io/r/grid/unit.html'>unit</a></code> object. It can be a vector of length 1 or the number of heamtaps/annotations.</p></td>
    </tr>
    <tr>
      <th>main_heatmap</th>
      <td><p>Name or index for the main heatmap.</p></td>
    </tr>
    <tr>
      <th>padding</th>
      <td><p>Padding of the whole plot. The four values correspond to the bottom, left, top and right paddings.</p></td>
    </tr>
    <tr>
      <th>auto_adjust</th>
    ...
    <tr>
      <th>row_dend_side</th>
      <td><p>If auto-adjustment is on, to put the row dendrograms of the main heatmap to the most left side of the heatmap list or the most right side?</p></td>
    </tr>
    <tr>
      <th>row_sub_title_side</th>
      <td><p>There can be sub titles generated by the splitting of heatmaps. Similar setting as <code>row_dend_side</code>.</p></td>
    </tr>
    <tr>
      <th>column_dend_side</th>
      <td><p>Similar setting as <code>row_dend_side</code>.</p></td>
    </tr>
    <tr>
      <th>column_sub_title_side</th>
      <td><p>Similar setting as <code>row_sub_title_side</code>.</p></td>
    </tr>
    <tr>
      <th>row_gap</th>
      <td><p>Overwrite the corresponding setting in the main heatmap.</p></td>
    </tr>
    <tr>
      <th>cluster_rows</th>
      <td><p>Overwrite the corresponding setting in the main heatmap.</p></td>
    ...
    <tr>
      ...
      <td><p>Overwrite the corresponding setting in the main heatmap.same setting as in <code><a href='Heatmap.rd.html'>Heatmap</a></code>, if it is specified, <code>clustering_method_rows</code> in main heatmap is ignored.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      <th>show_row_dend</th>
      <td><p>same Overwrite the corresponding setting in the main heatmap.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><p>column Overwrite the corresponding setting in the main heatmap.</p></td>
    </tr>
    <tr>
    ...
    <p>It sets the size of each component of the heatmap list and adjusts graphic
parameters for each heatmap if necessary.</p>
<p>This function is only for internal use.</p>
    
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>A <code><a href='HeatmapList-class.rd.html'>HeatmapList-class</a></code> object in which settings for all heatmap are adjusted.</p>
