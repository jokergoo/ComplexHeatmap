...
<title>Set Names — set_name • ComplexHeatmap</title>
...
<meta property="og:title" content="Set Names — set_name" />

<meta property="og:description" content="Set Names" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>set_name.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='fu'><a href='set_name.rd.html'>set_name</a></span>(<span class='no'>m</span>)</pre>
...
<span class='fu'><a href='set_name.rd.html'>set_name</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt; [1] "a" "b" "c"</div></pre>
  </div>
