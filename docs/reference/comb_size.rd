...
<title>Sizes of the Combination sets — comb_size • ComplexHeatmap</title>
...
<meta property="og:title" content="Sizes of the Combination sets — comb_size" />

<meta property="og:description" content="Sizes of the Combination sets" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Sizes of the Combination sets</h1>
    
    <div class="hidden name"><code>comb_size.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Sizes of the Combination sets</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='comb_size.rd.html'>comb_size</a></span>(<span class='no'>m</span>, <span class='kw'>degree</span> <span class='kw'>=</span> <span class='kw'>NULL</span>)</pre>
    ...
    <tr>
      <th>degree</th>
      <td><p>degree of the intersection. The value can be a vector.</p></td>
    </tr>
    </table>
    
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>A vector of sizes of the combination sets.</p>
...
<span class='fu'><a href='comb_size.rd.html'>comb_size</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt; 010 001 110 101 011 111 
#&gt;   1   8   4   2   6   4 </div></pre>
  </div>
