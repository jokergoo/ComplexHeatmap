...
<title>Number of Observations — nobs.SingleAnnotation • ComplexHeatmap</title>
...
<meta property="og:title" content="Number of Observations — nobs.SingleAnnotation" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>nobs.SingleAnnotation.rd</code></div>
    </div>
...
<span class='fu'><a href='https://rdrr.io/r/stats/nobs.html'>nobs</a></span>(<span class='no'>object</span>, <span class='no'>...</span>)</pre>
    ...
    <p>It returns the <code>n</code> slot of the annotaton function. If it does not exist, it returns <code>NA</code>.</p>
