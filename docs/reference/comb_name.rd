...
<title>Names of the Combination sets — comb_name • ComplexHeatmap</title>
...
<meta property="og:title" content="Names of the Combination sets — comb_name" />

<meta property="og:description" content="Names of the Combination sets" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Names of the Combination sets</h1>
    
    <div class="hidden name"><code>comb_name.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Names of the Combination sets</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='comb_name.rd.html'>comb_name</a></span>(<span class='no'>m</span>)</pre>
    ...
    <p>The name of the combination sets are formatted as a string
...
<code>mode</code> from <code><a href='make_comb_mat.rd.html'>make_comb_mat</a></code>.</p>
    
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>A vector of names of the combination sets.</p>
...
<span class='fu'><a href='comb_name.rd.html'>comb_name</a></span>(<span class='no'>m</span>)</div><div class='output co'>#&gt; [1] "010" "001" "110" "101" "011" "111"</div></pre>
  </div>
