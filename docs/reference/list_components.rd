...
<title>List All Heatmap Components — list_components • ComplexHeatmap</title>
...
<meta property="og:title" content="List All Heatmap Components — list_components" />

<meta property="og:description" content="List All Heatmap Components" />
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>List All Heatmap Components</h1>
    
    <div class="hidden name"><code>list_components.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>List All Heatmap Components</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='list_components.rd.html'>list_components</a></span>()</pre>
        
    <h2 class="hasAnchor" id="value"><a class="anchor" href="#value"></a>Value</h2>

    <p>A vector of viewport names.</p>
