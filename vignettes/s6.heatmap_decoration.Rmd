...
%\VignetteIndexEntry{Heatmap Decoration}
...
for(heatmap_name in c("ht1", "ht2")) {
    ...
    seekViewport(qq("@{heatmap_name}_hclust_column")); grid.rect(gp = gpar(fill = NA, col = "red"))
...
seekViewport(qq("ht1_hclust_row_2")); grid.rect(gp = gpar(fill = NA, col = "red"))
seekViewport(qq("ht1_hclust_row_1")); grid.rect(gp = gpar(fill = NA, col = "red"))
