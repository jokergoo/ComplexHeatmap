...
\arguments{
  ...
  \item{rownames_side}{should the row names be put on the left or right of the heatmap.}
  \item{show_rownames}{whether show row names.}
  \item{rownames_gp}{graphic parameters for drawing text.}
  \item{colnames_side}{should the column names be put on the top or bottom of the heatmap.}
  \item{show_colnames}{whether show column names.}
  \item{colnames_gp}{graphic parameters for drawing text.}
  \item{annotation}{column annotation. The value should be a data frame for which rownames correspond to column names of the matrix and columns correspond to different annotations.}
  \item{annotation_color}{colors for the annotations. The value is a list in which each element corresponds to each annotation and the value for each element is a vector or a color mapping function which depends on the annotation is discrete or continuous.}
