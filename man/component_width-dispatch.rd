...
\itemize{
\item \code{\link{component_width,HeatmapList-method}}, \code{HeatmapList} class method
\item \code{\link{component_width,Heatmap-method}}, \code{Heatmap} class method
}
