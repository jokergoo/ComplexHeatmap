...
\itemize{
\item \code{\link{component_height,HeatmapList-method}}, \code{HeatmapList} class method
\item \code{\link{component_height,Heatmap-method}}, \code{Heatmap} class method
}
